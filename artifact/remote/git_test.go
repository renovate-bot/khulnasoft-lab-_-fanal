	...
	tests := []struct {
	...
	}{
		{
			...
			want: types.ArtifactReference{
				...
				ID:   "sha256:b72d59e8adb0822e552632bd4c9a695598d75f725ef6816b8b8bf542abbfa8ef",
				BlobIDs: []string{
					"sha256:b72d59e8adb0822e552632bd4c9a695598d75f725ef6816b8b8bf542abbfa8ef",
				},
			},
		},
	}
...
func Test_newURL(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "happy path",
			args: args{
				rawurl: "https://github.com/khulnasoft-lab/fanal",
			},
			want: "https://github.com/khulnasoft-lab/fanal",
		},
		{
			name: "happy path: no scheme",
			args: args{
				rawurl: "github.com/khulnasoft-lab/fanal",
			},
			want: "https://github.com/khulnasoft-lab/fanal",
		},
		{
